...
let originalData = {};
class LiveStreamAdvancedSettings extends React.Component {
    constructor() {
        super();
        this.state = {
            data: {
    ...
    initEntry = () => {
        Ajax({
            url: "ajax/GetLiveStreamAdvanceSettings.w",
            onSuccess: (data) => {
                this.setState({
                    data
                });
    ...
    handleApply = () => {
        ...
        //发送数据
        Ajax({
            url: "ajax/SetLiveStreamAdvanceSettings.w",
            data: data,
            onSuccess: () => {
                Layer.msg({
...
export default LiveStreamAdvancedSettings;